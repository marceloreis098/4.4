...
const AIAssistantWidget: React.FC<{ currentUser: User }> = ({ currentUser }) => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            if (result.error) {
                let friendlyError = "Ocorreu um erro inesperado no servidor. Tente novamente mais tarde.";
                if (result.error.includes("Cannot find module '@google/genai'")) {
                    ...
                    friendlyError = "Problema de faturamento com a API do Gemini. Verifique sua conta Google Cloud.";
                }
